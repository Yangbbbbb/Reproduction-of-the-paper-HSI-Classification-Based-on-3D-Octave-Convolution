...
load_path1 = './DataSet/PaviaU (1).mat'
load_data = sio.loadmat(load_path1)
data_load = load_data["paviaU"]
load_path2 = './DataSet/PaviaU_gt(1).mat'
...
print("./data/data_train"+str(data_train.shape))
print("./data/data_test"+str(data_test.shape))
print("./data/labels_train"+str(labels_train.shape))
print("./data/labels_test"+str(labels_test.shape))
print("*********************************************************")
